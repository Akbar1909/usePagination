...
declare const usePagination: <ListItemType = object, FiltersType = object>(filters?: FiltersType | undefined, initialState?: Partial<IPaginationState<ListItemType, FiltersType>> | undefined) => {
