...
var paginationReducer = function (state, _a) {
    ...
    switch (type) {
        ...
        case PAGINATION_ACTION_TYPES.ADD_NEW_FILTERS:
            return tslib_1.__assign(tslib_1.__assign({}, state), { filters: tslib_1.__assign(tslib_1.__assign({}, state.filters), payload) });
...
var usePagination = function (filters, initialState) {
    var _a = (0, react_1.useReducer)((paginationReducer), tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, defaultState), initialState), { filters: filters })), state = _a[0], dispatch = _a[1];
    ...
    var setTotal = (0, react_1.useCallback)(function (total) { return dispatch({ type: PAGINATION_ACTION_TYPES.SET_TOTAL, payload: total }); }, []);
    ...
    var setLimit = (0, react_1.useCallback)(function (limit) { return dispatch({ type: PAGINATION_ACTION_TYPES.SET_LIMIT, payload: limit }); }, []);
    ...
    var resetList = (0, react_1.useCallback)(function () { return dispatch({ type: PAGINATION_ACTION_TYPES.SET_LIST, payload: {} }); }, []);
    var setList = (0, react_1.useCallback)(function (list, force) {
        var _a, _b;
        if (force === void 0) { force = false; }
        var newList = force ? (_a = {}, _a[state.page] = list, _a) : tslib_1.__assign(tslib_1.__assign({}, state.list), (_b = {}, _b[state.page] = list, _b));
    ...
    return tslib_1.__assign({ setPage: setPage, setTotal: setTotal, setLimit: setLimit, setIsFetching: setIsFetching, addNewFilter: addNewFilter, resetList: resetList, setList: setList, updateAnyFields: updateAnyFields }, state);
};
